...
export type ArrowGradientBgIconProps = SVGProps<SVGSVGElement>

export const ArrowGradientBgIcon: React.FC<ArrowGradientBgIconProps> = ({
  className,
  ...props
}) => {
  const gradientId = "arrow-bg-gradient"
  return (
    <svg
    ...
    >
      <defs>
        ...
        >
          <stop offset="0" stopColor="#117628" />
          <stop offset="1" stopColor="#84b7ff" />
        </linearGradient>
      </defs>
      <path
